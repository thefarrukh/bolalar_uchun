...
urlpatterns = [
    ...
    # Question Options
    path('question-options/', QuestionOptionListCreateView.as_view(), name='questionoption-list'),
    path('question-options/<int:pk>/', QuestionOptionDetailView.as_view(), name='questionoption-detail'),
